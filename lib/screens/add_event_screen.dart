          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const SizedBox(height: 10), // Add some vertical space between the date/time and the selected date/time
                Text(
                  DateFormat('yyyy-MM-dd hh:mm a').format(_dateTime), // Format the date and time
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          try {
                            await events.add(event.toMap()); // Save event to Firestore
